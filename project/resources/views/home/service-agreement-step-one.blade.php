        ...
        <!-- END JUMBOTRON -->
          ...
          <div id="rootwizard" class="m-t-10">
                      ...
                      <div class="tab-content">
                         ...
                         @endif
                        <form class="form-group" method="POST" action="{{ route('form.form.wizard.submit') }}">
                        {{ csrf_field() }}
                            ...
                            <div class="client-info sm-m-b-3">
                                ...
                                <div class="row clearfix mb-1 sm-p-0 mt-4" >
                                    <div class="col-md-6">
                                      <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" class="form-control client_info"  name="companyName" id="companyName" placeholder="Company Name" value="<?php echo $user->business_name?>" >
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" class="form-control client_info" id="contactName" name="contactName" placeholder="Contact Name" value="<?php echo $order->customer_name?>" >
                                 ...
                                 <div class="row clearfix mb-2">
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                      <label>Phone</label>
                                      <input id="phone" type="tel" pattern="\d{3}\-\d{3}\-\d{4}" name="telephone" class="form-control telephone client_info" data-mask="(999)-999-9999" placeholder="(999)-999-9999" value="<?php echo $order->customer_phone?>"   />
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                      <label>Email</label>
                                      <input type="email" class="form-control"  name="email" id="email" value="<?php echo $order->customer_email?>"  placeholder="joan@lifeforcephysio.com">
                               ...
                               <div class="row clearfix mb-1">
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                      ...
                                      <input type="text" class="form-control client_info" id="bill-firstName" name="addresss1" placeholder="Addresss Line 1" value="<?php echo $customer->address?>" >
                                        @error('addresss1') <div class="text-danger">{{ $message }}</div> @enderror
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                      <label>Addresss Line 2</label>
                                      <input type="text" class="form-control" id="bill-lastName" name="addresss2" placeholder="Addresss Line 2" value="{{ old('addresss2') }}">
                                       @error('addresss2') <div class="text-danger">{{ $message }}</div> @enderror
                                    </div>
                                  </div>
                                </div>
                                <div class="row clearfix mb-1">
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                      <label>City</label>
                                      <input type="text" class="form-control client_info" id="bill-city" name="city" value="<?php echo $customer->city?>"  placeholder="City" >
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                      ...
                                      <input type="text" class="form-control " id="bill-state" name="state" value="<?php echo $customer->Province_State?>"  placeholder="State/Province/Region">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                      ...
                                      <input type="text" class="form-control client_info" id="bill-postal" name="postal"  placeholder="postal" value="<?php echo $customer->zip?>">
                                      @error('postal') <div class="text-danger">{{ $message }}</div> @enderror
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="serv-check justify-content-between d-inline-flex w-100">
                                ...
                                <div class="row clearfix mb-1">
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                      <label>Addresss Line 1</label>
                                      <input type="text" class="form-control client_info" id="shipp-firstName" name="billing_address_1" placeholder="Addresss Line 1" value="{{ old('billing_address_1') }}">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                      <label>Addresss Line 2</label>
                                      <input type="text" class="form-control" id="shipp-lastName" name="billing_address_2" placeholder="Addresss Line 2" value="{{ old('billing_address_2') }}">
                                ...
                                <div class="row clearfix mb-1">
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                      <label>City</label>
                                      <input type="text" class="form-control client_info" id="shipp-city" name="billing_city" placeholder="City" value="{{ old('billing_city') }}">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                      <label>State/Province/Region</label>
                                      <input type="text" class="form-control" id="shipp-state" name="billing_state" placeholder="State/Province/Region" value="{{ old('billing_state') }}">
                                       @error('billing_city')<div class="text-danger">{{ $message }}</div> @enderror
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                      <label>Postal Code</label>
                                      <input type="text" class="form-control client_info" id="shipp-postal" name="billing_postal" placeholder="Postal Code" value="{{ old('billing_postal') }}">
                                      @error('billing_city')<div class="text-danger">{{ $message }}</div> @enderror
                                    </div>
                                  </div>
                                </div>
                              <div class="row clearfix mb-5">
                                <div class="col-md-6">
                                  <div class="form-group form-group-default required">
                                    <label>Phone</label>
                                    <input type="text" class="form-control client_info" id="shipp-phoneNumber" name="billing_telephone" value="{{ old('billing_telephone') }}" placeholder="(999)-999-9999">
                                    @error('billing_telephone')<div class="text-danger">{{ $message }}</div> @enderror
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group form-group-default">
                                    <label>Email</label>
                                    <input type="email" class="form-control" id="shipp-email" name="billing_email" placeholder="Email" value="{{ old('billing_email') }}">
                                    @error('billing_email')<div class="text-danger">{{ $message }}</div> @enderror
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <ul class="pager wizard no-style">
                            <li class="save">
                              <button aria-label="" class="btn btn-primary btn-cons from-left pull-right"  type="submit">
                                <span><a href="#" onclick="">Save</a></span>
                              </button>
                            </li>
                          </ul>
                          </div>

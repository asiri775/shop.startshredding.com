          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <a class="btn btn-primary btn-right pull-right"
                  onclick="printPage( '{{route('home.user-documents-print', ['id' => $order->id])}}' )"
                    ...
                    <tr>
                      <td class="text-center" colspan="3">
                        <div class="popdiv text-right">
                          <img class="makeitcounticon" src="{{asset('/assets/img/ribon.png')}}"> Make It Count <a id="popover-div"  target="_blank" rel="popover" title="Make It Count"><i class="icon-info1 fs-16 bold color-danger"></i></a> 
                        </div>
                      </td>
                      <td class="text-left">
                        <span class=" bold">$</span>
                        <label>{{$documents->make_it_count}}</label>
                      </div>
                      </td>
                    </tr>
                    <tr>
        ...
        <div class="col-md-12">
          <div class="row clearfix mb-1">
            <div class="col-md-6">
              ...
              <div>
                <label>Expiry : <?php echo $documents->credit_card_expire_month?>/<?php echo $documents->credit_card_expire_year?></label>
              </div>
              <div>
            ...
            <div class="col-md-6">
              <div class="main-title mt-4">
                <h3 class="font-montserrat bold fs-16 bold all-caps no-margin">Digital Signature</h3>
              </div>
              <div class="">
                <img src="{{asset('/photos').'/'.$documents->order_id.'.jpg'}}">
                <label>Signature : {{$documents->contact_name}}</label>
              </div>
            </div>
          </div> 
        </div>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $("#download-btn").click(function (e) {
        ...
        window.location.href = '/document_download/<?php echo $order->id;?>';
    });
  });

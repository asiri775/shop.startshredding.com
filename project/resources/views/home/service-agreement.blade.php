        ...
        <div class=" container-fluid  p-b-50 m-t-40">
            ...
            <div id="rootwizard" class="m-t-10">
                      ...
                      <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" id="top">
                        <li class="nav-item">
                          <a class="active d-flex align-items-center" data-toggle="tab" data-target="#tab1" role="tab"><i class="icon-user fs-14 tab-icon"></i> <span>Client information</span></a>
                        </li>
                        <li class="nav-item">
                          <a class="d-flex align-items-center" data-toggle="tab" data-target="#tab2" role="tab"><i class="icon-file-text1 fs-14 tab-icon"></i> <span>Terms and Conditions</span></a>
                        </li>
                        <li class="nav-item">
                          <a class="d-flex align-items-center" data-toggle="tab" data-target="#tab3" role="tab"><i class="icon-credit-card1 fs-14 tab-icon"></i> <span>Credit card information</span></a>
                        </li>
                        <!--li class="nav-item">

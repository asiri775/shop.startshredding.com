                                    ...
                                    <div class="">
                                        <table class="table table-hover table-condensed table-responsive table-responsive"
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 50%;"><font color="#fc7b03">Inovoice ID</font></th>
                                                <th style="width: 50%;"><font color="#fc7b03">Token</font></th>
                                            ...
                                            <tbody>
                                                @foreach($card_details as $card)
                                                    <tr class="text-center">
                                                        <td class="fs-12">{{date('m/d/Y', strtotime($card->created_at))}}</td>
                                                        <td class="fs-12">{{ $card-> invoice_id}}
                                                        </td>

                                                        <td class="fs-12">{{ $card->token }}</td>

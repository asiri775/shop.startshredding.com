...
@section('content')
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div id="exTab2" class="col-12">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="{{ url('/vendor/customer/' . $client->id . '/templates') }}">Templates</a>
                                </li>
                                <li class="active"><a
                                        href="{{ url('/vendor/customer/' . $client->id . '/orders') }}">Orders</a>
                                </li>
                                <li><a href="{{ url('/vendor/customer/' . $client->id . '/billing') }}">Billing</a></li>
                                <li><a href="{{ url('/vendor/customer/' . $client->id . '/documents') }}">Documents</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active mt-3" id="3">
                                            ...
                                            <div class="form-group">
                                                <div class="form-inline">
                                                    ...
                                                    <div class="col-md-2 col-xs-12">
                                                        ...
                                                        <input type="text" style="width: 100%;" class="form-control"
                                                            name="clientName"
                                                            value="<?= isset($_GET['clientName']) && $_GET['clientName'] != '' ? $_GET['clientName'] : '' ?>"
                                                            id="customer">
                                                    </div>
                                                    <div class="col-md-2 col-xs-12">
                                                        ...
                                                        <select class="form-control" name="type" id="type"
                                                            ...
                                                            <option value="{{ $type->id }}"
                                                                <?php if(isset($_GET['type']) && $_GET['type'] == $type->id){?>selected<?php } ?>>
                                                                {{ $type->name }}</option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 col-xs-12">
                                                        ...
                                                        <select class="form-control" name="quickdate" id="quickDate"
                                                            style="width: 100%;">
                                                ...
                                                <div class="form-inline">
                                                    <div class="col-md-2 col-xs-12">
                                                        ...
                                                        <div id="datepicker2" class="input-group date custom-calendar"
                                                            ...
                                                            <input style="width: 100%;" class="form-control datepicker"
                                                                id="fromTime" name="fromTime" type="text"
                                                                value="<?= (isset($_GET['fromTime']) && $_GET['fromTime']) != '' ? $_GET['fromTime'] : '' ?>"
                                                                style="width: 100%;" />
                                                            <span class="input-group-addon"><i
                                                                    class="fa fa-calendar fromTimeCalendar"></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 col-xs-12">
                                                        <label>To</label>
                                                        <div id="datepicker3" class="input-group date custom-calendar"
                                                            ...
                                                            <span class="input-group-addon"><i
                                                                    class="fa fa-calendar toTimeCalendar"></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 col-xs-12">
                                    ...
                                    <div
                                        class="panel-body-custom tableContainParent panel col-md-12 col-lg-12 col-sm-12 left-tab">
    ...
    <script>
        $(function() {
            ...
            var quickDate = $('#quickDate').val();
            var status = $('#status').val();
            var method = $('#method').val();
            var type = $('#type').val();
            var clientName = $('#customer').val();
            ...
            var table = $('#orders-table').DataTable({
                ...
                ajax: {
                    url: '{{ url('vendor/get-template-order-ajax') }}/{{ $client->id }}',
                    type: 'GET', // 👈 important
                    data: function(d) {
                        d.orderId = $('#orderId').val() || '';
                        d.quickdate = $('#quickDate').val() || '';
                        d.fromTime = $('#fromTime').val() || '';
                        d.toTime = $('#toTime').val() || '';
                        d.clientName = $('#customer').val() || '';
                        d.status = $('#status').val() || '';
                        d.method = $('#method').val() || '';
                        d.type = $('#type').val() || '';
                        d.orderForm = 'Search';
                ...
                columns: [{
                        ...
                        'sortable': false,
                        'render': function(id) {
                            return '<input type="checkbox" name="chk_orders[]" value="' + $(
                                '<div/>').text(id).html() + '">';
                        }
                    },
                    {
                        ...
                        'sortable': false,
                        'render': function(id) {
                            return '<a target="_blank" href="/vendor/details/' + $('<div/>').text(
                                id).html() + '" >' + $('<div/>').text(id).html() + '</a>';
                        }
                    },
                    {
                        data: 'customer_name',
            ...
            <div class="modal-content">
                ...
                <form id="store-deposit" action="{{ route('vendor.order.notify') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="successMessageSend" style="display:none;" class="alert alert-success" role="alert">
                            Invoice
                            successfully sent.
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form id="store-deposit" action="{{ route('vendor.order.notify.all') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" placeholder="email@domain.com" class="form-control" name="send_email">
                        <div id="successMessageSendAll" style="display:none;" class="alert alert-success"
                            role="alert"> Invoice
                            successfully sent.
                        </div>
                    </div>

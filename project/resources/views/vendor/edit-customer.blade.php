            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left-table">
                <div class="bg-white row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <form action="{{ route('vendor.customer_update') }}" role="form" class="form-horizontal"
                            id="ClientHomeForm" method="post" accept-charset="utf-8" style="width: 100%;">
                            {{ csrf_field() }}
                            <input type="hidden" name="hf_client_id" class="form-control" id="hf_client_id"
                                value="{{ $client->id }}">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="txt_business_name" class="form-control" placeholder="Business Name"
                                                id="txt_business_name" type="text" value="{{ $client->business_name }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="CONTACT_FIRST_NAME" class="col-sm-4 col-form-label">First Name *</label>
                                        <div class="col-sm-8">
                                            <input name="txt_first_name" class="form-control" placeholder="First Name"
                                                id="txt_first_name" required type="text"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="txt_last_name" class="form-control" placeholder="Last Name"
                                                id="txt_last_name" required type="text"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="txt_customer_type" class="form-control" id="txt_customer_type"
                                                required>
                                                <option value="">Select Customer Type</option>
                                                <option value="Contract"
                                                    {{ $client->customer_type == 'Contract' ? 'selected' : '' }}>Contract
                                                </option>
                                                <option value="Purge"
                                                    {{ $client->customer_type == 'Purge' ? 'selected' : '' }}>Purge
                                                </option>
                                                <option value="Drop Off"
                                                    {{ $client->customer_type == 'Drop Off' ? 'selected' : '' }}>Drop Off
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="txt_department" class="form-control" placeholder="Department"
                                                id="txt_department" type="text" value="{{ $client->department }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="status">Status *</label>
                                        <div class="col-sm-8">
                                            <select name="txt_status_stages" class="form-control" id="txt_status_stages"
                                                required>
                                                <option value="">Select Status</option>
                                                <option value="Prospect"
                                                    {{ $client->status_stages == 'Prospect' ? 'selected' : '' }}>Prospect
                                                </option>
                                                <option value="Lead"
                                                    {{ $client->status_stages == 'Lead' ? 'selected' : '' }}>Lead</option>
                                                <option value="Customer"
                                                    {{ $client->status_stages == 'Customer' ? 'selected' : '' }}>Customer
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="payment_method">Payment Method
                                            *</label>
                                        <div class="col-sm-8">
                                            <select name="txt_payment_method" class="form-control"
                                                id="txt_payment_method" required>
                                                <option value="">Select Payment Method</option>
                                                <option value="Credit Card"
                                                    {{ $client->payment_method == 'Credit Card' ? 'selected' : '' }}>Credit
                                                    Card</option>
                                                <option value="Cash"
                                                    {{ $client->payment_method == 'Cash' ? 'selected' : '' }}>Cash</option>
                                                <option value="Credit"
                                                    {{ $client->payment_method == 'Credit' ? 'selected' : '' }}>Credit
                                                </option>
                                                <option value="Cheque"
                                                    {{ $client->payment_method == 'Cheque' ? 'selected' : '' }}>Cheque
                                                </option>
                                                <option value="EFT"
                                                    {{ $client->payment_method == 'EFT' ? 'selected' : '' }}>EFT</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="txt_tax_group" class="form-control" id="txt_tax_group"
                                                required>
                                                <option value="">Select Tax Group</option>
                                                @foreach ($tax_groups as $group)
                                                    <option value="{{ $group->GROUP_NAME }}"
                                                        {{ $client->TAX_GROUP == $group->GROUP_NAME ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="txt_source" class="form-control" id="txt_source" required>
                                                ...
                                                <option value="Online"
                                                    {{ $client->source == 'Online' ? 'selected' : '' }}>Online</option>
                                                <option value="Referral"
                                                    {{ $client->source == 'Referral' ? 'selected' : '' }}>Referral</option>
                                                <option value="Phone" {{ $client->source == 'Phone' ? 'selected' : '' }}>
                                                    Phone</option>
                                                <option value="Other" {{ $client->source == 'Other' ? 'selected' : '' }}>
                                                    Other</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="txt_invoicing_type" class="form-control"
                                                id="txt_invoicing_type" required>
                                                <option value="">Select Invoicing</option>
                                                <option value="Single"
                                                    {{ $client->invoicing_type == 'Single' ? 'selected' : '' }}>Single
                                                </option>
                                                <option value="Batch"
                                                    {{ $client->invoicing_type == 'Batch' ? 'selected' : '' }}>Batch
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <select name="txt_manager" class="form-control" id="txt_manager" required>
                                                ...
                                                @foreach ($account_managers as $manager)
                                                    <option value="{{ $manager->FULL_NAME }}"
                                                        {{ $client->Account_Manager == $manager->FULL_NAME ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="txt_email" class="form-control" placeholder="Email" required
                                                id="txt_email" type="email" value="{{ $client->email }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="PHONE" class="col-sm-4 col-form-label">Phone</label>
                                        <div class="col-sm-2 col-4 pr-1">
                                            <input name="txt_phone1" class="form-control" maxlength="3"
                                                placeholder="000" id="txt_phone1" type="text"
                                                value="{{ substr($client->phone, 0, 3) }}">
                                        </div>
                                        <div class="col-sm-2 col-4 pr-1">
                                            <input name="txt_phone2" class="form-control" maxlength="3"
                                                placeholder="000" id="txt_phone2" type="text"
                                                value="{{ substr($client->phone, 3, 3) }}">
                                        </div>
                                        <div class="col-sm-4 col-4">
                                            <input name="txt_phone3" class="form-control" maxlength="4"
                                                placeholder="0000" id="txt_phone3" type="text"
                                                value="{{ substr($client->phone, 6, 4) }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="txt_address" class="form-control" placeholder="Address"
                                                id="txt_address" type="hidden" value="{{ $client->address }}">
                                            <div class="map-section col-md-12 col-sm-12 col-xs-12"
                                                style="width: 100% !important;">
                                                <div id="locationField">
                                                    <input autocomplete="off" id="autocomplete" class="form-control"
                                                        placeholder="Enter address here" value="{{ $client->address }}" type="text">
                                                    </input>
                                    ...
                                    <input type="hidden" class="form-control" name="lontude" id="lontude" value="{{ $client->lontude }}">
                                    <input type="hidden" class="form-control" name="latude" id="latude" value="{{ $client->latude }}">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="address">Country</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="txt_country"
                                                id="txt_country" placeholder="Country" value="{{ $client->Country }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="CITY" class="col-sm-4 col-form-label">City</label>
                                        <div class="col-sm-8">
                                            <input name="txt_city" class="form-control" placeholder="City"
                                                id="txt_city" type="text" value="{{ $client->city }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="cmb_province" class="form-control" id="cmb_province">
                                                ...
                                                <option value="Alberta"
                                                    {{ $client->Province_State == 'Alberta' ? 'selected' : '' }}>Alberta
                                                </option>
                                                <option value="British Columbia"
                                                    {{ $client->Province_State == 'British Columbia' ? 'selected' : '' }}>
                                                    British Columbia</option>
                                                <option value="Manitoba"
                                                    {{ $client->Province_State == 'Manitoba' ? 'selected' : '' }}>Manitoba
                                                </option>
                                                <option value="New Brunswick"
                                                    {{ $client->Province_State == 'New Brunswick' ? 'selected' : '' }}>New
                                                    Brunswick</option>
                                                <option value="Newfoundland"
                                                    {{ $client->Province_State == 'Newfoundland' ? 'selected' : '' }}>
                                                    Newfoundland</option>
                                                <option value="Northwest Territorie"
                                                    {{ $client->Province_State == 'Northwest Territorie' ? 'selected' : '' }}>
                                                    Northwest Territorie</option>
                                                <option value="Nova Scotia"
                                                    {{ $client->Province_State == 'Nova Scotia' ? 'selected' : '' }}>Nova
                                                    Scotia</option>
                                                <option value="Nunavut"
                                                    {{ $client->Province_State == 'Nunavut' ? 'selected' : '' }}>Nunavut
                                                </option>
                                                <option value="Ontario"
                                                    {{ $client->Province_State == 'Ontario' ? 'selected' : '' }}>Ontario
                                                </option>
                                                <option value="Prince Edward Island"
                                                    {{ $client->Province_State == 'Prince Edward Island' ? 'selected' : '' }}>
                                                    Prince Edward Island</option>
                                                <option value="Quebec"
                                                    {{ $client->Province_State == 'Quebec' ? 'selected' : '' }}>Quebec
                                                </option>
                                                <option value="Saskatchewan"
                                                    {{ $client->Province_State == 'Saskatchewan' ? 'selected' : '' }}>
                                                    Saskatchewan</option>
                                                <option value="Yukon"
                                                    {{ $client->Province_State == 'Yukon' ? 'selected' : '' }}>Yukon
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-6 pr-1">
                                            <input name="txt_fsa1" class="form-control" maxlength="3" id="txt_fsa1"
                                                type="text" value="{{ substr($client->zip, 0, 3) }}">
                                        </div>
                                        <div class="col-sm-4 col-6">
                                            <input name="txt_fsa2" class="form-control" maxlength="3" id="txt_fsa2"
                                                type="text" value="{{ substr($client->zip, 3, 3) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center" style="margin-top:20px;">
                                <a href="{{ route('vendor.customer.show', ['id' => $client->id]) }}"
        ...
        $(document).ready(function() {
            ...
            function fillInAddress(results, status) {
                ...
                $.map(results, function(item) {
                    ...
                    document.getElementById("txt_address").value = street_number + " " + route;
                    document.getElementById("txt_city").value = locality;
                    ...
                    if (postal_code) {
                        ...
                        document.getElementById("txt_fsa1").value = postal_code_array[0] == null ? '' :
                            postal_code_array[0];
                        document.getElementById("txt_fsa2").value = postal_code_array[1] == null ? '' :
                            postal_code_array[1];
                    }

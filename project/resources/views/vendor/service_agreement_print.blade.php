...
<div class="">
    ...
    <form action="{{route('vendor.complete_sa')}}" method="post">
        <div class="row clearfix mb-1 col-md-12">
        <br />
        <div class="main-title mt-4 col-md-6">
    ...
    <div class="card card-default row">
        ...
        <div class="row col-md-12 mb-3 mt-4"> 
            <div class="col-md-6 mb-2">
                <h5 class="all-caps mt-1 mb-1">Service Date</h5>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <div class="form-group form-group-default col-md-12 time-group">
                ...
                <table class="table borderless">
                    ...
                    <tr>
                        ...
                        <div class="popdiv text-right">
                            Make It Count <a id="popover-div"  target="_blank" rel="popover" title="Make It Count"><i class="icon-info1 fs-16 bold color-danger"></i></a> 
                        </div>
                        </td>
                        <td class="text-left">
        ...
        <div class="row col-md-12 mb-3 mt-4">
            <div class="row">
                <p class="fs-14">The Grand Total and Line amounts displayed are estimates based on the quantity displayed. The final amount for invoicing and payment may change
